        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-3">
            ...
            <Link to="/" className="flex items-center space-x-2 group flex-shrink-0">
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-green-200 overflow-hidden shadow-sm group-hover:shadow-md transition-all duration-300 bg-green-50 flex items-center justify-center">
